...
export const ZH_CN: LocaleDict = {
  ...
  "table.bidCapped": "已按预算上限截断为 {amount}",
  "table.lockBid": "锁定报价",
  "table.locked": "已锁定",
  "table.pass": "弃权（0）",
  "table.useTool": "使用工具",
  ...
  "hud.estimatedHint": "该数值是基于当前已知线索计算的期望值（无偏平均），并非保证下限；随着更多信息揭示，实际总值可能更高或更低。",
  "hud.round": "回合 {round}",
  "hud.analyst": "分析师",
  "hud.budget": "预算",
  "catalog.open": "藏品图鉴",
  "catalog.title": "藏品图鉴",
  "catalog.close": "关闭图鉴",
  "catalog.footprint": "占格筛选",
  "catalog.tier": "品级",
  "catalog.category": "类别",
  "catalog.all": "全部",
  "catalog.empty": "没有符合筛选条件的藏品。",
  "catalog.value": "基准估值",
  "catalog.size": "尺寸",
  "event.feed.title": "拍卖事件",
  "event.source.auctioneer": "拍卖师",
  "event.source.analyst": "分析员",
  "event.source.tool": "工具",
  "event.source.bidding": "竞价",
  "event.intel.exhausted": "本轮没有新增情报。",
  "event.intel.field.tier": "一件拍品的品级揭示为 {tier}",
  "event.intel.field.category": "一件拍品的类别揭示为 {category}",
  "event.intel.field.shape": "一件拍品的占格轮廓已揭示",
  "event.intel.field.identity": "一件拍品被鉴定",
  "event.intel.field.value": "一件拍品的价值揭示为 {value}",
  "event.intel.multi.shape": "{count} 件拍品的占格轮廓已揭示",
  "event.intel.multi.tier": "{count} 件拍品的品级已揭示",
  "event.intel.multi.category": "{count} 件拍品的类别已揭示",
  "event.intel.multi.identity": "{count} 件拍品被鉴定",
  "event.intel.multi.value": "{count} 件拍品的价值已揭示",
  "event.intel.aggregate.count": "类别 {key} 共有 {value} 件",
  "event.intel.aggregate.countTier": "品级 {key} 共有 {value} 件",
  "event.intel.aggregate.mean": "类别 {key} 的平均价值为 {value}",
  "event.tool.used": "{seat} 使用了工具 {toolId}",
  "event.bidding.continue": "第 {round} 回合未成交，继续拍卖",
  "event.bidding.sold": "成交！{seat} 以 {amount} 取得拍品",
  "event.bidding.tiebreak": "第 {round} 回合最高价并列，进入加赛",
  "event.bidding.noSale": "再次并列，流拍",
  "presentation.setup-progress": "准备中",
  "presentation.auction-ready": "第 1 回合准备完成",
  "presentation.round-intel": "新情报公开",
  "presentation.bids-progress": "报价提交中",
  "presentation.bids-ready": "全部报价就绪",
  "presentation.bids-revealed": "报价揭晓",
  "presentation.round-outcome": "回合结果",
  "presentation.completed": "拍卖结束",
...
export const EN: LocaleDict = {
  ...
  "table.bidCapped": "Capped to your budget: {amount}",
  ...
  "hud.estimatedHint": "Expected value from currently known clues (an unbiased average, not a guaranteed floor); the true total may end up higher or lower as more is revealed.",
  "hud.round": "Round {round}",
  "hud.analyst": "Analyst",
  "hud.budget": "Budget",
  "catalog.open": "Collectibles catalog",
  "catalog.title": "Collectibles catalog",
  "catalog.close": "Close catalog",
  "catalog.footprint": "Footprint filter",
  "catalog.tier": "Tier",
  "catalog.category": "Category",
  "catalog.all": "All",
  "catalog.empty": "No collectibles match these filters.",
  "catalog.value": "Base value",
  "catalog.size": "Size",
  "event.feed.title": "Auction events",
  "event.source.auctioneer": "Auctioneer",
  "event.source.analyst": "Analyst",
  "event.source.tool": "Tool",
  "event.source.bidding": "Bidding",
  "event.intel.exhausted": "No new intel this round.",
  "event.intel.field.tier": "An object's tier was revealed as {tier}",
  "event.intel.field.category": "An object's category was revealed as {category}",
  "event.intel.field.shape": "An object's footprint was revealed",
  "event.intel.field.identity": "An object was appraised",
  "event.intel.field.value": "An object's value was revealed as {value}",
  "event.intel.multi.shape": "Footprints of {count} objects were revealed",
  "event.intel.multi.tier": "Tiers of {count} objects were revealed",
  "event.intel.multi.category": "Categories of {count} objects were revealed",
  "event.intel.multi.identity": "{count} objects were appraised",
  "event.intel.multi.value": "Values of {count} objects were revealed",
  "event.intel.aggregate.count": "Category {key} contains {value} objects",
  "event.intel.aggregate.countTier": "Tier {key} contains {value} objects",
  "event.intel.aggregate.mean": "Category {key} mean value is {value}",
  "event.tool.used": "{seat} used tool {toolId}",
  "event.bidding.continue": "Round {round} ended without sale; auction continues",
  "event.bidding.sold": "Sold! {seat} takes the lot at {amount}",
  "event.bidding.tiebreak": "Round {round} top bids tied; tiebreak",
  "event.bidding.noSale": "Tied again; the lot is not sold",
  "presentation.setup-progress": "Setting up",
  "presentation.auction-ready": "Round 1 ready",
  "presentation.round-intel": "New intel revealed",
  "presentation.bids-progress": "Bids coming in",
  "presentation.bids-ready": "All bids ready",
  "presentation.bids-revealed": "Bids revealed",
  "presentation.round-outcome": "Round outcome",
  "presentation.completed": "Auction ended",
  ...
  "result.lotBoard": "This match's lot",
